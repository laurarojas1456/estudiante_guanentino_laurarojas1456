...
def abrir_toplevel_centigrados():
    ...
    toplevel_resultados.title("Centigrados")
    toplevel_resultados.resizable(False, False)
    toplevel_resultados.geometry("300x200")
